...
def parse_args():
    ...
    parser.add_argument("--generate_interval", type=float, default=0.5)  # (in hours) saves samples and generator
    parser.add_argument("--training_time", type=float, default=8)  # how many hours to train (optional)
