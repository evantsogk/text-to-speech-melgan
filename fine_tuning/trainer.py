...
def save_original_samples(test_loader, device, args, writer):
    """
    ...
    for i, batch in enumerate(test_loader):
        real_audio, _, _, _, real_mel = batch
...
def train(train_loader, test_loader, fft, generator, discriminator, optim_g, optim_d, device, args):
    ...
    test_mel, test_audio = save_original_samples(test_loader, device, args, writer)
